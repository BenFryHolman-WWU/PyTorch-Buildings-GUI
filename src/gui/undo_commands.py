...
#             return
#         self.canvas.area_delete_preview_items.discard(self.component_item)
#         self.canvas.building_model.remove_componentItem(self.component_item)
#         self.canvas.scene.removeItem(self.component_item)
...
#     def undo(self):
#         # Add component back to scene + model
#         self.canvas.scene.addItem(self.component_item)
#         self.canvas.building_model.add_componentItem(self.component_item) 
#         self.component_item.setFlag(QGraphicsRectItem.GraphicsItemFlag.ItemIsMovable, self.canvas.editing_enabled)
#         self.component_item.setFlag(QGraphicsRectItem.GraphicsItemFlag.ItemIsSelectable, self.canvas.editing_enabled)
#         self.canvas.set_dirty(True) #?
