...
class HeaderBar(QWidget):
    ...
    def _create_home_tab(self):
        ...
        save_as_btn = self._create_action_button("Save As", self.callbacks["save_as"], "save_as_asset", "save_as")
        new_page_btn = self._create_action_button("New", self.callbacks["new"], "new_asset", "new")
        ...
        undo_btn = self._create_action_button("Undo", self.callbacks["undo"], "undo_asset", "undo")
        redo_btn = self._create_action_button("Redo", self.callbacks["redo"], "redo_asset", "redo")
