...
def days_of_year(t: torch.Tensor) -> torch.Tensor:
    """Vectorized day-of-year from seconds-since-epoch tensor."""
    return (t % (365 * 86400)) // 86400 + 1
...
def hours_of_day(t: torch.Tensor) -> torch.Tensor:
    """Vectorized hour-of-day (0-23) from seconds-since-epoch tensor."""
    return (t % 86400) // 3600
